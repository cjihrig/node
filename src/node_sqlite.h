...
class SQLiteStatementSync : public BaseObject {
 public:
  SQLiteStatementSync(Environment* env, v8::Local<v8::Object> object, sqlite3* db, sqlite3_stmt* stmt);
  void MemoryInfo(MemoryTracker* tracker) const override;
  static v8::Local<v8::FunctionTemplate> GetConstructorTemplate(
      Environment* env);
  static BaseObjectPtr<SQLiteStatementSync> Create(Environment* env, sqlite3* db, sqlite3_stmt* stmt);
